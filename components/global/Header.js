      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            <a href="/iletisim" className="text-base font-medium text-gray-500 hover:text-gray-900">
              İletişim
            </a>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="#" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900" onClick={()=>toggle()}>
              Sign in
            </a>
            <a
              href="#"
            ...
            <div className="py-6 px-5 space-y-6">
              ...
              <div>
                ...
                <p className="mt-6 text-center text-base font-medium text-gray-500">
                  Existing customer?{' '}
                  <button type="button" href="#" className="text-indigo-600 hover:text-indigo-500" onClick={()=>toggle()}>
                    Sign in
                  </button>
                </p>
              </div>
